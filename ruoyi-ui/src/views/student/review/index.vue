<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="评价人ID" prop="reviewerId">
        <el-input
      ...
      <el-form-item label="被评价人ID" prop="reviewedId">
        <el-input
          v-model="queryParams.reviewedId"
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['student:review:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['student:review:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['student:review:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="reviewList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="评价人ID" align="center" prop="reviewerId" />
      <el-table-column label="被评价人ID" align="center" prop="reviewedId" />
      <el-table-column label="评分" align="center" prop="rating" />
      <el-table-column label="文字评价" align="center" prop="comment" />
...
<script>
import { listReview, getReview, delReview, addReview, updateReview } from "@/api/student/review"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除服务评价编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('student/review/export', {
        ...this.queryParams
