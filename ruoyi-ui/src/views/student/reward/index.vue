<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="兑换ID" prop="id">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['student:reward:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['student:reward:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['student:reward:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="rewardList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="奖品ID" align="center" prop="rewardId" />
      <el-table-column label="消耗积分" align="center" prop="pointsUsed" />
      <el-table-column label="兑换码" align="center" prop="code" />
      <el-table-column label="状态：1=已发放，2=已使用" align="center" prop="status" />
...
<script>
import { listReward, getReward, delReward, addReward, updateReward } from "@/api/student/reward"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除用户兑换记录编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('student/reward/export', {
        ...this.queryParams
